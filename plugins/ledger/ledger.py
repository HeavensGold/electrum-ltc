...
from electrum_ltc import bitcoin, constants  # Added constants To solve error "ADDRTYPE_P2PKH is not defined" 
    ...
    def perform_hw1_preflight(self):
        try:
            ...
            if self.has_detached_pin_support(self.dongleObject) and not self.is_pin_validated(self.dongleObject) and (self.handler is not None):
                ...
                self.dongleObject.setAlternateCoinVersion(constants.net.ADDRTYPE_P2PKH, constants.net.ADDRTYPE_P2SH) #setAlternateCoinVersions => setAlternateCoinVersion, added to variable names "constants.net."
        except BTChipException as e:
            if (e.sw == 0x6faa):
